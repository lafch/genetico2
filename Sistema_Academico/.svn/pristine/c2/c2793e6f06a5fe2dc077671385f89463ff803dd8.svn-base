 ...
 * @author biblioteca
 */
public class MBIncidenciaBibli {
    ...
    public SelectItem[] getCboTurno() {
        this.cboTurno= new SelectItem[3];
        this.cboTurno[0]= new SelectItem(79, "Mañana");
        this.cboTurno[1]= new SelectItem(81, "Tarde");
        this.cboTurno[2]= new SelectItem(80, "Noche");
        return cboTurno;
    }
    ...
    public void grabar(){
        ...
        this.objBeanIncidenciaLab.getTbIncidenciaLab().setTipoIncidencia("077002");
    ...
    public synchronized void buscar(){
        System.out.println("entro al metodo buscar");
        this.setListaIncidenciaLabs(new ArrayList<BeanIncidenciaLab>());
        this.getListaIncidenciaLabs().clear();
                
        TbIncidenciaLabDAO dao=(TbIncidenciaLabDAO) ServiceFinder.findBean("TbIncidenciaLabDAOHS");
        List<TbIncidenciaLab> lista=dao.getListarIncidenciaTipo("077002",this.w_descripcion);
        System.out.println("cntidad de la lista a busxcar -> "+lista.size());
        for(int i=0; i<lista.size(); i++){
