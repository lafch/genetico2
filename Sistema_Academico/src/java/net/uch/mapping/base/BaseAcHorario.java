...
/**
 * This is an object that contains data related to the ac_horario table.
...
public abstract class BaseAcHorario  implements Serializable {

	public static String REF = "AcHorario";
	 ...
	 */
	public BaseAcHorario (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
