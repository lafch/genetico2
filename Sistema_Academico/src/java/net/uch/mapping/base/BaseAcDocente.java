...
/**
 * This is an object that contains data related to the ac_docente table. Do not
 * modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class table="ac_docente"
 */
public abstract class BaseAcDocente implements Serializable {
    ...
    private java.util.Set<net.uch.mapping.AcDocenteCurso> AcDocenteCursos;

    /**
     * Return the unique identifier of this class
     *
     * @hibernate.id generator-class="native" column="doc_id"
     */
    ...
    public void addToAcDisponibilidads( net.uch.mapping.AcDisponibilidad acDisponibilidad ) {
        if ( null == getAcDisponibilidads() ) {
            setAcDisponibilidads( new java.util.TreeSet<net.uch.mapping.AcDisponibilidad>() );
        }
    ...
    public void addToAcVidaDocentes( net.uch.mapping.AcVidaDocente acVidaDocente ) {
        if ( null == getAcVidaDocentes() ) {
            setAcVidaDocentes( new java.util.TreeSet<net.uch.mapping.AcVidaDocente>() );
        }
        getAcVidaDocentes().add( acVidaDocente );
    }

    public Set<AcDocenteCurso> getAcDocenteCursos() {
        return AcDocenteCursos;
    }

    public void setAcDocenteCursos(Set<AcDocenteCurso> AcDocenteCursos) {
        this.AcDocenteCursos = AcDocenteCursos;
    }
    ...
    public boolean equals( Object obj ) {
        ...
        if ( !( obj instanceof net.uch.mapping.AcDocente ) ) {
            return false;
        } else {
            net.uch.mapping.AcDocente acDocente = (net.uch.mapping.AcDocente)obj;
            if ( null == this.getId() || null == acDocente.getId() ) {
                return false;
            } else {
                return ( this.getId().equals( acDocente.getId() ) );
            }
        }
    }
