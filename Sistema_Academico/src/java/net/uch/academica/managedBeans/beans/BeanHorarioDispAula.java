 ...
 * @author LUIS
 */
public class BeanHorarioDispAula extends AcHorarioDispAula {

    private boolean blSeleccionado;

    @Override
    public AcAula getAcAula() {
        return super.getAcAula();
    }
    ...
    public BeanHorarioDispAula( Integer aulaId ) {
        this.setAula_id( aulaId );
    ...
    public BeanHorarioDispAula( AcHorarioDispAula horaria ) {
        this.setAula_id( horaria.getAcAula().getId() );
    ...
    public AcHorarioDispAula getAcHorarioDispAula() {
        AcHorarioDispAula horaria = new AcHorarioDispAula();
        horaria.setHorId( this.getHorId() );

        horaria.setAcAula( new AcAula( this.aula_id ) );
    ...
    public String getV_hor_dia() {
        /* para poder actualizar el campo antes de ser guardado */
        HSCatalogoDAO daoCat;
        daoCat = CommonDAO.getTbCatalogoDAO();
        System.out.println( this.getHorDia() );
        v_hor_dia = daoCat.seleccionarDescripcion( this.getHorDia() );
        return v_hor_dia;
    }
    ...
    public void aceptar( ActionEvent event ) {
        ...
        sMsg = this.esValido();
        if ( sMsg.isEmpty() ) {
            this.actualizarDatos( this.aula_id );
    ...
    public void actualizarDatos( int aulaId ) {
        ...
        this.setAcAula( daoD.seleccionarAula( aulaId ) );
