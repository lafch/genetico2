...
public class ReportHistorialDeuda {
    ...
    public static void main(String[] args) {
        ...
        generateReportHistorialDeuda(8);
    }

    public static JasperPrint generateReportHistorialDeuda(int mod_id) {
        ...
        try {
            ...
            drb.addColumn("Alumno", "alumno", String.class.getName(), 60, headeralu);
    ...
    public static JasperPrint generateReportMontoDeudaSeccion(int sec_id) {
        ...
        try {
            ...
            report.addColumn("Alumno", "alumno", String.class.getName(), 60, headeralu);
