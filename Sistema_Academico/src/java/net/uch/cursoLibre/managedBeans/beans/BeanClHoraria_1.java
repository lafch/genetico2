 ...
 * @author cesardl
 */
public class BeanClHoraria_1 extends ClHoraria {
...
/*variables para la sede*/
    ...
    public BeanClHoraria_1(Integer secId) {
    ...
    public BeanClHoraria_1(ClHoraria horaria) {
    ...
    public boolean esValido() {
        return (!(getHorDia().equalsIgnoreCase("000000"))
