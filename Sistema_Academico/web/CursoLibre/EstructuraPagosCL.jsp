...
<html>
    <head>
        ...
        <title>Configuración de Estructuras de Pago</title>
            ...
            <rich:modalPanel id="mpUpdate" autosized="true" zindex="3000" width="550">
                ...
                <h:form id="form2">
                    <table style="font-size:12px; font-family:verdana; width: 100%">
                        ...
                        <tr>
                            <td><h:outputText value="Descripción Auxiliar"/>
                            </td>
                            <td>
                            ...
                            <td colspan="2" valign="top">
                                <div style="overflow-y:auto; height: 190px">
                                    <rich:dataTable id="tablaDetalle"
                                        ...
                                        <rich:column>
                                            <f:facet name="header">
                                                <h:outputText value="Descripción Auxiliar"/>
                                            </f:facet>
                        ...
                        <tr>
                            ...
                            <td>
                                <h:panelGrid columns="2"  id="tbCbosDetCont">
                                    <f:facet name="header">
                                        <h:outputText value="ESTRUCTURA DE PAGO DETALLE CONTINUACIÓN" />
                                    </f:facet>
                                    ...
                                    <h:outputText value="MÓDULO CONT. : " />
            ...
            <rich:modalPanel id="mpConfirmarEnlazar" width="300" height="100" zindex="3000" >
                ...
                <h:form id="frmConfirmEnlaceEstPagDet">
                    <table style="width: 100%;height: 100%;">
                        <tr>
                            <th colspan="2">
                                <h:outputText value="¿Seguro que desea asignar la continuación?" />
                            </th> 
                        </tr>
                        <tr>
                            <th>
