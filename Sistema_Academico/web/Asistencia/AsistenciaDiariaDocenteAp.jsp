                        ...
                        <tr>
                            ...
                            <td>
                                <a4j:commandButton image="/Imagenes/actions/viewmag.png" title="Buscar"
                                                   ...
                                                   reRender="fromTableAsisDoc, scrollTableAsisDoc, tableAsisDoc,codigoAL,idAL,nombreAL,txt_dato,suggestion,visualizar" />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <%--<tr style=" height : 24px;">
                            ...
                            <td>
                                ...
                                <rich:suggestionbox id="suggestion"
                                    ...
                                    <h:column>
                                        <h:outputText value="#{asis.b_doc_nombre}" style="font-weight: bold;" />
                                    </h:column>
                                    <h:column>
                                        <h:outputText value="#{asis.b_doc_codigo}" style="font-weight: bold;" />
                                    </h:column>
                                </rich:suggestionbox>
                            </td>
                        </tr>--%>
                ...
                <h:form id="fromTableAsisDoc" style="width: 100%">
                    ...
                    <rich:dataTable id="tableAsisDoc" rows="20"
                        ...
                        <rich:column style="text-align: center;">
                            ...
                            <a4j:commandButton id="visualizar" image="/Imagenes/actions/matricula.png"
                                               title="Ver Observacion" rendered="#{ses.b_visualizar}"
                                               ...
                                               reRender="a_doc_nombre, a_sec_nombre,a_estadoDocente, a_estasis, a_cur_nombre,a_fecha_reg, a_obs" />
                        </rich:column>
                    ...
                    <h:form id="form2">
                        <table width="100%">
                            ...
                            <tr style=" height : 24px;">
                                ...
                                <td>
                                    <h:outputText value="#{managerSEAsistenciaDocente.b_sesEstadoDocTipo}" id="a_estadoDocente"/>
                                </td>
                            </tr>
                            <tr style=" height : 24px;">
                            ...
                            <tr style=" height : 24px;">
                                ...
                                <td colspan="2">
                                    <h:inputTextarea id="a_obs" cols="20" rows="2" readonly="true" 
