            ...
            <rich:panel>
                    ...
                    <table width="100%" style="font-size:10px; font-family:verdana"  cellspacing="0" border="0" cellpadding="0">
                            ...
                            <td width="30%" align="right">
                                <h:graphicImage value="/Imagenes/actions/filenew.png" width="16"
                                    ...
                                    <a4j:support event="onclick"
                                                 action="#{mBIncidenciaLab.nuevo}"
                                                 oncomplete="#{mBIncidenciaLab.oncomplete}"
                                                 reRender="fModal"
                                                 />
                                </h:graphicImage>
                            </td>
                        ...
                        <tr>
                            <td colspan="3">
                                ...
                                <h:inputText size="40" value="#{mBIncidenciaLab.w_descripcion}"/>
                            </td>
                            <td colspan="4"></td>
                        </tr>
                    </table>
                ...
                <h:form>
                    <table  aling="center">
                        <tr>
                            <td>
                                <rich:dataTable value="#{mBIncidenciaLab.listaIncidenciaLabs}" var="lista" rowKeyVar="row" 
                                    ...
                                    <rich:column>
                                        <f:facet name="header"><h:outputText value="Equipo" /> </f:facet>
                                    ...
                                    <rich:column>
                                        ...
                                        <h:graphicImage value="/Imagenes/actions/no.png" alt="Eliminar" title="Eliminar">
                                            <a4j:support event="onclick" action="#{mBIncidenciaLab.abrirDelete}" oncomplete="#{mBIncidenciaLab.oncomplete}">
                                                <f:setPropertyActionListener target="#{mBIncidenciaLab.p_indice}" value="#{row}"/>
                                            </a4j:support>
                                        </h:graphicImage>
                                    </rich:column>
                                    */%>
                                    <rich:column>
                                        ...
                                        <h:graphicImage value="/Imagenes/actions/editpaste.png" alt="Modificar" title="Modificar">
                                            <a4j:support event="onclick" action="#{mBIncidenciaLab.seleccionar}" 
                                                         reRender="fModal" oncomplete="#{mBIncidenciaLab.oncomplete}">
                                                <f:setPropertyActionListener target="#{mBIncidenciaLab.p_indice_inci}" value="#{row}"/>
                                            </a4j:support>
                                        </h:graphicImage>
                                    </rich:column>
                                    <f:facet name="footer">
                    ...
                    <table aling="center" width="300px">
                        <tr>
                            <td colspan="2" align="right">
                                ...
                                <a4j:commandButton image="/Imagenes/actions/filesave.png" action="#{mBIncidenciaLab.grabar}" 
                                                   reRender="fModal,dtLista" oncomplete="#{mBIncidenciaLab.oncomplete}" />
                            </td>
                        </tr>
                        <tr>
                            <td><h:outputText value="Alumno" /></td>
                            <td><h:inputText value="#{mBIncidenciaLab.w_suggestionDato}" size="40" id="iAlumno"> 
                                    
                                </h:inputText>
                                <rich:suggestionbox id="suggestionAlumno"
                                                    for="iAlumno" nothingLabel="Alumno No Encontrado"
                                                    suggestionAction="#{mBIncidenciaLab.listaSuggestion}" var="listaAlu" 
                                    ...
                                    <a4j:support ajaxSingle="true" event="onselect"
                                                 actionListener="#{mBIncidenciaLab.seleccionarAlumnoSugg}" 
                        ...
                        <tr>
                            ...
                            <td><h:outputText value="#{mBIncidenciaLab.objBeanIncidenciaLab.tbIncidenciaLab.acAlumno.aluCodigo}" id="iCodigo"> 
                                </h:outputText>
                        ...
                        <tr>
                            ...
                            <td>
                                <h:outputText value="#{mBIncidenciaLab.objBeanIncidenciaLab.tbIncidenciaLab.acAlumno.esp.espNombre}" id="iProfesion" />
                            </td>
                        </tr>
                        <tr>
                            <td><h:outputText value="Curso" /></td>
                            <td>
                                <h:selectOneMenu value="#{mBIncidenciaLab.objBeanIncidenciaLab.tbIncidenciaLab.curId}" id="iCurso">
                                    <f:selectItems value="#{mBIncidenciaLab.cboCursos}" />
                                    <a4j:support event="onchange" action="#{mBIncidenciaLab.seleccionarCurso}" reRender="iCiclo,iTurno"/>
                                </h:selectOneMenu>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <h:outputText value="#{mBIncidenciaLab.objBeanIncidenciaLab.winc_ciclo}" id="iCiclo" />
                            </td>
                        </tr>
                        <tr>
                            <td><h:outputText value="Turno de Practicas" /></td>
                            <td>
                                <h:outputText value="#{mBIncidenciaLab.objBeanIncidenciaLab.tbIncidenciaLab.acTurno.turNombre}" id="iTurno" />
                            </td>
                        </tr>
                        <tr>
                            <td><h:outputText value="Estado" /></td>
                            <td>
                                <h:selectOneMenu value="#{mBIncidenciaLab.objBeanIncidenciaLab.tbIncidenciaLab.inclabEstado}" id="iEstado">
                                    <f:selectItems value="#{mBIncidenciaLab.cboEstadoLaboratorio}" />
                                </h:selectOneMenu>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <rich:calendar value="#{mBIncidenciaLab.objBeanIncidenciaLab.tbIncidenciaLab.inclabFechaRegistro}" datePattern="dd/MM/yyyy" />
                            </td>
                        </tr>
                        <tr>
                            <td><h:outputText value="Equipo" /></td>
                            <td>
                                <h:inputText value="#{mBIncidenciaLab.objBeanIncidenciaLab.tbIncidenciaLab.inclabEquipo}" id="iEquipo" size="43" /> 
                            </td>
                        </tr>
                        <tr>
                            <td valing="top"><h:outputText value="Descripcion del Daño" /></td>
                            <td>
                                <h:inputTextarea cols="40" rows="4" id="iDescripcion" value="#{mBIncidenciaLab.objBeanIncidenciaLab.tbIncidenciaLab.inclabDescripcionDanio}" />
                            </td>
                        </tr>
                    </table>       
                </a4j:form>
