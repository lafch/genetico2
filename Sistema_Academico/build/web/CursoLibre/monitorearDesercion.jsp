            ...
            <rich:panel>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size:10px; font-family:verdana">
                        ...
                        <tr>
                            ...
                            <td colspan="9" align="left">
                                <h:selectOneMenu id="cboModulos" value="#{managerMonitoreoDesercion.moduloId}" >
                                    ...
                                    <a4j:support event="onchange" reRender="cboCursos"/>
                                </h:selectOneMenu>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="9" align="left">
                                <h:selectOneMenu id="cboCursos" value="#{managerMonitoreoDesercion.cursoId}" >
                                    <f:selectItems value="#{managerMonitoreoDesercion.cboCurso}" />
                        ...
                        <tr>
                            ...
                            <td width="5%" align="left">
                                <h:outputText value="Interesados:" />
                            </td>
                            <td colspan="6" align="left">
                                <h:selectManyCheckbox value="#{managerMonitoreoDesercion.selectedItems2}">
                                    <f:selectItem itemValue="0" itemLabel="Activar" />
                                </h:selectManyCheckbox>
                            </td>
                        </tr>
                ...
                <h:form id="frmTbDesertores">
                    ...
                    <rich:dataTable id="tbDesertores"
                        ...
                        <rich:column style="background-color:#{desertor.expr13 == 'SI'?'#BFDFFF':'#FFFFFF'}">
                            <f:facet name="header">
                                <h:outputText value="INTERESADO" />
                            </f:facet>
                            <h:outputText value="#{desertor.expr13}"/>
                        </rich:column>
                        <rich:column>
                            <f:facet name="header">
            ...
            <rich:modalPanel id="mpModifObs" zindex="3000" width="450" height="630">
                ...
                <h:form id="frmModifObs">
                    <h:panelGrid style="width:100%;">
                        ...
                        <h:outputText value="GRADO DE INTERES: " style="font-weight: bold;" />
                        <h:panelGroup>
                            <h:selectBooleanCheckbox id="chkInteres" value="#{managerMonitoreoDesercion.beanClAlumDeser.gradoInteres}"/>
                            <h:outputLabel for="chkInteres" style="color:#265CFF" value="Obs: marcado: interes alto/ sin marcar:sin interes" />
                            <br />
                            <rich:spacer height="7" />
                        </h:panelGroup>
