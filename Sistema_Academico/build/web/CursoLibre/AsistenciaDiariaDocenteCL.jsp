...
<html>
    <head>
        ...
        <title>Asistencia diaria docente del Centro de Producción</title>
    ...
    <f:view>
        <body>
            ...
            <f:facet name="ASISTENCIA DIARIA DOCENTE DEL CENTRO DE PRODUCCIÓN"></f:facet>
            <h:form id="form1" style="width:100%">
                <table style="font-size:13px; font-family:verdana; width: 100%">
                    <tr>
                        <td width="100%" colspan="2" ><strong>ASISTENCIA DIARIA DOCENTE DEL CENTRO DE PRODUCCIÓN</strong>
                        </td>
                        <td align="rigth">
                    </td>
