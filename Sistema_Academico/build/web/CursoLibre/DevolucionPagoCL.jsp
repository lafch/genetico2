                        ...
                        <tr>
                            <td width="100%" colspan="10">
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td align="left"><h:outputText value="DEVOLUCIÓN DE PAGOS" style="font-weight: bold;"/></td>
                                        <td align="right">
                                            ...
                                            <a4j:commandButton image="/Imagenes/actions/viewmag.png"
                                                               action="#{managerCLMatricula.SeleccionarMatriculas}"
                                ...
                                <rich:dataTable id="tablaMaster" value="#{managerCLMatricula.matriculas}"
                                    ...
                                    <rich:subTable id="subtable" value="#{mat.matriculas}" var="det"
                                        ...
                                        <rich:column style="text-align: center;">
                                            <f:facet name="header">
                                                <h:outputText value="Anular Pago"/>
                                            </f:facet>
                                            ...
                                            <a4j:commandButton image="/Imagenes/actions/delete.gif"
                                                               ...
                                                               actionListener="#{managerCLMatricula.VerificarPagosMatriculaAnulacion}"
                                                               oncomplete="#{managerCLMatricula.oncomplete}"
                                                               reRender="amMensaje"/>
                                        </rich:column>
                        ...
                        <tr>
                            <td align="center" valign="middle">
                                <a4j:commandButton image="/Imagenes/actions/button_accept.png"
                                                   title="Aceptar"
                                                   actionListener="#{managerCLMatricula.AnularMatriculaDevolucion}"
